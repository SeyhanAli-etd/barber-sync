...
// AuthContext'in var olduğunu ve bir "token" sağladığını varsayıyoruz.
// Henüz oluşturmadıysanız, bu kısmı şimdilik null olarak düşünebilirsiniz.
// import { useAuth } from '../hooks/useAuth';

const NotificationContext = createContext();

export const NotificationProvider = ({ children }) => {
  // const { token } = useAuth(); // Gerçek uygulamada bu şekilde olacak
  const token = localStorage.getItem('token'); // Şimdilik token'ı localStorage'dan alalım
